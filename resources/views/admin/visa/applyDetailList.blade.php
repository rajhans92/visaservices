...
@section('content')
    <h3 class="page-title">Visa Apply Page Content</h3>

    {!! Form::model($applyData, ['method' => 'POST', 'route' => ['admin.visa.applyDetailSave',$applyData->visa_id], 'files'=>true]) !!}
          ...
          <div class="row">
              <div class="col-xs-6 form-group">
                @if($applyData->thank_you_img != "")
                  ...
                  <div>
                    <img src="{{url('images/visa/apply/'.$applyData->thank_you_img) }}" onerror="this.src='{{ url('images/default.png') }}'" id="img_left" width="100" height="100"/>
                  </div>
                @endif
              </div>
            </div>
