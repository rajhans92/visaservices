...
@section('content')
    ...
    {!! Form::model($faqData, ['method' => 'PUT', 'route' => ['admin.visa.faqEdit',$id,$faqData->id], 'files'=>true]) !!}
        ...
        <div class="panel-body">
          ...
          <div class="row">
            <div class="col-xs-6 form-group">
              {!! Form::label('question', 'Visa Faq Question*', ['class' => 'control-label']) !!}
    ...
    <a href="{{ route('admin.visa.faqList',$id) }}" class="btn btn-primary">Cancel</a>
    {!! Form::close() !!}
@stop
