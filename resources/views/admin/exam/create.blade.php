        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-xs-4 form-group">
                    ...
                    <select class="form-control selectpicker multipleSelect" required multiple name="language[]" data-live-search="true" >
                ...
                <div class="col-xs-4 form-group">
                      ...
                      {!! Form::select('exam_category_id', $exam_category, old('exam_category_id') ? old('exam_category_id') : 0,['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                      <p class="help-block"></p>
            ...
            <div class="row">
              <div class="col-xs-4 form-group">
                    ...
                    {!! Form::select('organization_id', $orgObj,old('organization_id') ? old('organization_id') : 0,['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-4 form-group">
                      ...
                      {!! Form::select('teacher_id', $teacherObj, old('teacher_id') ? old('teacher_id') : 0,['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                      <p class="help-block"></p>
                  ...
                  <div class="col-xs-4 form-group">
                      ...
                      {!! Form::number('exam_duration', old('exam_duration'), ['class' => 'form-control','required' => '', 'placeholder' => '']) !!}
                      <p class="help-block"></p>
            ...
            <div class="row">
                ...
                <div class="col-xs-4 form-group">
                    ...
                    {!! Form::number('passing_marks', old('passing_marks'), ['class' => 'form-control','required' => '', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-4 form-group">
                  ...
                  {!! Form::select('questions_type', $questionType,old('questions_type') ? old('questions_type') : 0,['class' => 'form-control', 'placeholder' => '','required' => '']) !!}
                  <p class="help-block"></p>
                ...
                <div class="col-xs-4 form-group">
                  ...
                  {!! Form::select('submit_type', $submitType,old('submit_type') ? old('submit_type') : 0,['class' => 'form-control', 'placeholder' => '','required' => '']) !!}
                  <p class="help-block"></p>
                  ...
                  <div class="col-xs-12 form-group">
                      ...
                      <div class="input-group date">
                          ...
                          <span class="input-group-addon">
                              <span class="glyphicon glyphicon-remove" id="file_remove" style="display:none;">
                              </span>
                              <span class="glyphicon glyphicon-upload" id="file_upload" style="display:inline-block;">
                              </span>
                          </span>
                      </div>
                ...
                <div class="row">
                  <div class="col-xs-12 form-group">
                    ...
                    <div class="input-group date">
                          ...
                          <span class="input-group-addon">
                              <span class="glyphicon glyphicon-remove" id="image_remove" style="display:none;">
                              </span>
                              <span class="glyphicon glyphicon-upload" id="image_upload" style="display:inline-block;">
                              </span>
                          </span>
                      </div>
                  ...
                  <div class="col-xs-12 form-group">
                    <img src="" id="image_name_show" style="display: none;" class="avatar-xlarge uk-border-circle shadow"  width="100px" height="100px"/>
                  </div>
                </div>
              </div>
            </div>
