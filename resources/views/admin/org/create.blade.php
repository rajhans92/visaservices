...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            @lang('global.app_create') &nbsp;&nbsp;     <a href="{{ route('admin.org.index') }}" class="btn btn-default">@lang('global.app_back_to_list')</a>
        </div>
                ...
                <div class="col-xs-4 form-group">
                    {!! Form::label('established_date', 'Established Date*', ['class' => 'control-label']) !!}
                      <div class='input-group date'>
                          <input type='text'  name="established_date" readonly class="form-control" id="established_date" value="{{old('established_date')}}" required/>
