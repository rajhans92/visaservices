...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            @lang('global.app_edit') &nbsp;&nbsp;     <a href="{{ route('admin.org.index') }}" class="btn btn-default">@lang('global.app_back_to_list')</a>
        </div>
                ...
                <div class="col-xs-4 form-group">
                    {!! Form::label('established_date', 'Established Date*', ['class' => 'control-label']) !!}
                      <div class='input-group date'>
                          <input type='text'  name="established_date" readonly value="{{ old('established_date') ? old('established_date') : date('d-m-Y',strtotime($user->established_date))}}" class="form-control" id="established_date" required/>
