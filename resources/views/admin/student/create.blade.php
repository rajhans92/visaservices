...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            @lang('global.app_create') &nbsp;&nbsp;     <a href="{{ route('admin.student.index') }}" class="btn btn-default">@lang('global.app_back_to_list')</a>
        </div>
                ...
                <div class="col-xs-4 form-group">
                    {!! Form::label('dob', 'Date Of Birth*', ['class' => 'control-label']) !!}
                      <div class='input-group date'>
                          <input type='text'  name="dob" readonly class="form-control" id="dob" required/>
