        ...
        <div class="panel-body">
          ...
          <div class="row">
            <div class="col-xs-6 form-group">
                ...
                {!! Form::textarea('services_content_1', old('services_content_1'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                <p class="help-block"></p>
            ...
            <div class="col-xs-6 form-group">
                ...
                {!! Form::textarea('services_content_2', old('services_content_2'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                <p class="help-block"></p>
