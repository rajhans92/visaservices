...
@section('content')
    ...
    {!! Form::model($blogData, ['method' => 'PUT', 'route' => ['admin.blog.update',$blogData->id], 'files'=>true]) !!}
        ...
        <div class="panel-body">
          <div class="row">
              <div class="col-xs-6 form-group">
                @if($blogData->landing_img != "")
                  ...
                  <div>
                    <img src="{{url('images/blog/'.$blogData->landing_img) }}" onerror="this.src='{{ url('images/default.png') }}'" id="img_left" width="100" height="100"/>
                  </div>
                @endif
              </div>
            </div>
          <div class="row">
            <div class="col-xs-4 form-group">
              ...
              <div class="input-group date">
                  <input type="file" class='form-control file_name' size="1" name="landing_img" accept="image/*" />
              </div>
            ...
            <div class="col-xs-4 form-group">
              ...
              <select class="form-control selectpicker" required name="blog_category_id" value="" >
                  ...
                  @foreach($categoryList as $val)
                    <option value="{{$val->id}}" {{$blogData->category_id == $val->id ? "selected":""}}>{{$val->name}}</option>
                  @endforeach
              </select>
            </div>
            <div class="col-xs-4 form-group">
            ...
            <div class="col-xs-4 form-group">
              ...
              <select class="form-control selectpicker" required name="main_button_url" value="" >
                  ...
                  @foreach($routeList as $val)
                    <option value="{{$val->visa_url}}" {{$val->visa_url == $blogData->main_button_url ? "selected" : ""}}>{{$val->visa_url}}</option>
                  @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-4 form-group">
                ...
                <select name="whatsapp_status" class="form-control whatsapp_status">
                   <option value="0" {{$blogData->whatsapp_status == 0 ? "selected":""}}>No</option>
                   <option value="1" {{$blogData->whatsapp_status == 1 ? "selected":""}}>Yes</option>
                </select>
                <p class="help-block"></p>
          ...
          <div class="row">
            ...
            <div class="col-xs-4 form-group">
                ...
                <select name="call_status" class="form-control whatsapp_status">
                   <option value="0" {{$blogData->call_status == 0 ? "selected":""}}>No</option>
                   <option value="1" {{$blogData->call_status == 1 ? "selected":""}}>Yes</option>
                </select>
                <p class="help-block"></p>
          ...
          <div class="row">
            <div class="col-xs-6 form-group">
                ...
                {!! Form::textarea('content_1', old('content_1'), ['class' => 'form-control tinymceEditor', 'placeholder' => '', 'required' => '']) !!}
                <p class="help-block"></p>
            ...
            <div class="col-xs-6 form-group">
                ...
                {!! Form::textarea('content_2', old('content_2'), ['class' => 'form-control tinymceEditor', 'placeholder' => '', 'required' => '']) !!}
                <p class="help-block"></p>
