...
@section('content')
    ...
    <form action="{{route('admin.exam-schedule.store')}}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
              ...
              <div class="col-xs-4 form-group">
                  {!! Form::label('start_date', 'Exam Start Date Time*', ['class' => 'control-label']) !!}
                    <div class='input-group date'>
                        <input type='text'  name="start_date" class="form-control" id="start_date" autocomplete="off" value="{{old('start_date')}}" required/>
                ...
                <div class="col-xs-4 form-group">
                    {!! Form::label('end_date', 'Exam End Date Time*', ['class' => 'control-label']) !!}
                      <div class='input-group date'>
                          <input type='text'  name="end_date" class="form-control" id="end_date" value="{{old('end_date')}}" autocomplete="off" required/>
                          <span class="input-group-addon">
                              <span class="glyphicon glyphicon-calendar"></span>
                          </span>
                      </div>
                ...
                <div class="col-xs-4 form-group">
                    {!! Form::label('result_date', 'Exam Result Date Time*', ['class' => 'control-label']) !!}
                      <div class='input-group date'>
                          <input type='text'  name="result_date" class="form-control" id="result_date" value="{{old('result_date')}}" autocomplete="off" required/>
                          <span class="input-group-addon">
                              <span class="glyphicon glyphicon-calendar"></span>
                          </span>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-remove" id="exam_logo_remove" style="display:none;">
                                </span>
                                <span class="glyphicon glyphicon-upload" id="exam_logo_upload" style="display:inline-block;">
                                </span>
                            </span>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-remove" id="exam_banner_remove" style="display:none;">
                                </span>
                                <span class="glyphicon glyphicon-upload" id="exam_banner_upload" style="display:inline-block;">
                                </span>
                            </span>
                          </div>
