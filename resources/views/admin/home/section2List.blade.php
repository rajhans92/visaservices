...
@section('content')
    ...
    {!! Form::model($homeData, ['method' => 'PUT', 'route' => ['admin.home.section2Update', $homeData->language_id], 'files'=>true]) !!}
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-xs-6 form-group">
                {!! Form::label('section_2_title', 'Section Heading*', ['class' => 'control-label']) !!}
                {!! Form::text('section_2_title', old('section_2_title'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
              ...
              <div class="row">
                <div class="col-xs-6 form-group">
                  {!! Form::label('img','Image')!!}
                  <div>
                    <img src="{{url('images/home/'.$homeData->img_4) }}" onerror="this.src='{{ url('images/default.png') }}'" id="img_left" width="100" height="100"/>
                  </div>
                </div>
              </div>
              @endif
              <div class="row">
                <div class="col-xs-3 form-group">
                  {!! Form::label('img_4','Image')!!}
                  <div class="input-group date">
                    <input type="hidden"  name="file_delete" id="file_delete" value="0" />
                    <input type="file" class='form-control file_name' size="1" name="img_4" accept="image/*" />
                    <span class="input-group-addon">
                      <span class="glyphicon glyphicon-remove" id="file_remove" style="{{$homeData->img_4 != "" ? 'display:inline-block':'display:none'}};">
                      </span>
                      <span class="glyphicon glyphicon-upload" id="file_upload" style="{{$homeData->img_4 != "" ? 'display:none':'display:inline-block'}};">
                      </span>
                    </span>
                  </div>
                  <p class="help-block file_name_error">
